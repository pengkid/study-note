...
使用方法很简单：创建一个 iframe，使用 iframe 的一个方法 postMessage 可以跨于文档发送消息，然后监听 message，可以获得其他文档发来的消息。
...
<body>
    <iframe src="http://localhost:8081/server.html" style='display: none;'></iframe>
    <script>
